...
public interface BoardMapper {
    ...
    @Select("SELECT NO, TITLE, CONTENTS, RECOMMEND, VIEW_CNT, CATEGORY, USER.USER_NIC AS AUTHOR, DATE_FORMAT(APPLY_DATE, '%Y-%m-%d') AS APPLY_FORMAT_DATE FROM BOARD JOIN USER ON USER.USER_ID = BOARD.USER_ID WHERE NO=#{no}")
