...
const RankComment = () => {
    ...
    const getComment = async () => {
        ...
        param["orderBy"] = time;
        try {
            const res = await dbGet("/board/rankComment", param);
            if (res) {
                setCmt(res);
            }
        } catch (e) {
    ...
    const append_comment = async () => {
        ...
        try {
            comment["category"] = "rank";

            const res = await dbPost("/board/rankComment", comment);
            if (res === 1) {
    ...
    const deleteComment = async (id) => {
        try {
            const res = await dbPut("/board/rankComment/delete", {id: id});
            if (res === 200) {
                getComment();
            }
        } catch (e) {
